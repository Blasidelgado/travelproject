...
export default function navBar(sessionStatus) {
    ...
    `<div class="container-fluid flex-nowrap">
        ...
        <div class="collapse navbar-collapse flex-grow-1 w-75 z-1" id="navbarNav">
            <ul class="navbar-nav d-lg-flex justify-content-evenly w-100">
                ...
                <li class="nav-item page-btn" data-page="userJourneys">My journeys</li>
    ...
    `<div class="container-fluid flex-nowrap">
        <div class="container w-25">
            <img class="navbar-brand page-btn" data-page="home" src="/media/logo.jpg" alt="logo" role="button" width="85" height="70">        </div>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </div>
        </button>
